...
function Ctrl($scope, $http) {
	...
	$scope.shippingMethods = [
	    {name:'每公斤', value:0, hide:0, disabledSetUnitWeight:0},
	    {name:'每件', value:1, hide:0, disabledSetUnitWeight:1},
	    {name:'總運費(忽略重量或件數)', value:2, hide:0, disabledSetUnitWeight:1},
	    {name:'不考慮運費', value:3, hide:1, disabledSetUnitWeight:1}
	];
	$scope.shippingMethod = $scope.shippingMethods[0];
